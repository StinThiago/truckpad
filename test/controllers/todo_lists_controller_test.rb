...
class TodoListsControllerTest < ActionController::TestCase
  ...
  test "should create todo_list" do
    assert_difference('TodoList.count') do
      post :create, todo_list: { description: @todo_list.description, due_date: @todo_list.due_date, user_id: @todo_list.user_id }
    end
  ...
  test "should update todo_list" do
    patch :update, id: @todo_list, todo_list: { description: @todo_list.description, due_date: @todo_list.due_date, user_id: @todo_list.user_id }
    assert_redirected_to todo_list_path(assigns(:todo_list))
  end
